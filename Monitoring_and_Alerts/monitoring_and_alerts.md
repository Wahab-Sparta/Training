...
3. You will see a pop-up to either select an existing dashboard or create a new one. 
...
The default setting on AWS for your monitoring to update is every 5 minutes.  
...
Now paste your InstanceID (which you can find in your instance summary page), then click enter.
...
1. Provide a name and you may provide a description too.  
The description allows markdown formatting (but it is only applied when viewing the alarm in the console, not when viewing the notification). Once completed, click "Next".
